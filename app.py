...
class PasswordManagerCLI:
    ...
    def get_entry(self):
        ...
        search_term = input("Search by service or username: ").strip()
        ...
        for entry in all_entries:
            if search_term.lower() in entry['username'].lower():
                    ...
                    if exists and not skip_duplicates:
                        ...
                        for db_entry in all_entries:
                            if db_entry['service'] == service and db_entry['username'] == username:
                                self.db.update_entry(db_entry['id'], service, username, encrypted_password)
                                imported_count += 1
                                break
                    else:
                        # Add new entry
